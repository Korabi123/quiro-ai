...
interface TwoFactorAddedEmailProps {
  methodType: "Email verification" | "Authenticator app";
}

export function TwoFactorAddedEmail({
  methodType,
}: TwoFactorAddedEmailProps) {
  return (
    <Html lang="en">
      <Head>
      ...
      <Preview>A new 2FA method has been added to your account</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={heading}>Two-Step Verification Added</Heading>
            <Text style={paragraph}>
              This is a confirmation that a new two-step verification method (<strong>{methodType}</strong>) has been successfully added to your Quiro AI account.
            </Text>
...
export default TwoFactorAddedEmail;
