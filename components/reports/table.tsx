...
import { searchReports } from "@/lib/client-search";
                ...
                {report.summary &&
                  (() => {
                    ...
                    if (scorePercentage < 50) {
                      badgeColor =
                        "bg-red-400/20 border-red-400/50 text-red-500";
                    } else if (scorePercentage < 75) {
                      badgeColor =
                        "bg-yellow-400/20 border-yellow-400/50 text-yellow-500";
                    } else {
                      badgeColor =
                        "bg-green-400/20 border-green-400/50 text-green-500";
                    }

                    return (
                      <Badge
                        variant={"outline"}
                        className={cn("p-2", badgeColor)}
                      >
